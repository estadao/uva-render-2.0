<script>
	...
	import Heading from "components/headings/DefaultHeading.svelte";
	import Text from "components/texts/Text.svelte";
	import Image from "components/images/ImageContainer_responsive.svelte";
	import Chart from "components/charts/UvaContainer.svelte";
    import Datawrapper from "components/charts/DatawrapperContainer.svelte";
